...
namespace OnlineTest.Services.Services
{
    public class MailService : IMailService
    {
        ...
        public bool SendMail(MailDTO mail)
        {
            ...
            emailMessage.From.Add(new MailboxAddress(_mailConfig.DisplayName, _mailConfig.SenderEmail));
            ...
            using (var smtp = new SmtpClient())
            {
                try
                {
                    ...
                    smtp.Authenticate(_mailConfig.SenderEmail, _mailConfig.Password);
