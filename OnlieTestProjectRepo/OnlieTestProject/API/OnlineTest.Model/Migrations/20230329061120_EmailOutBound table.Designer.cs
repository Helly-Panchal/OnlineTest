...
namespace OnlineTest.Model.Migrations
{
    ...
    [Migration("20230329061120_EmailOutBound table")]
    partial class EmailOutBoundtable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineTest.Model.MailOutBound", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineTest.Model.MailOutBound", b =>
                {
                    b.HasOne("OnlineTest.Model.TestEmailLink", "TestEmailLink")
                        .WithMany()
                        .HasForeignKey("TestLinkId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("TestEmailLink");
                });
